...
public class RescheduleLoansApiConstants {
    ...
    public static final String recurringGraceOnPrincipalParamName = "recurringGraceOnPrincipal";
    ...
    public static final Set<String> CREATE_REQUEST_DATA_PARAMETERS = new HashSet<>(Arrays.asList(localeParamName, dateFormatParamName,
            graceOnPrincipalParamName, recurringGraceOnPrincipalParamName, graceOnInterestParamName, extraTermsParamName, rescheduleFromDateParamName,
